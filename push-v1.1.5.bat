@echo off
echo ========================================
echo Laravel PHPMailer Driver v1.1.5 Release
echo ========================================
echo.
...
git commit -m "Release v1.1.5 - Complete configuration fixes with all SSL and debug options"
echo.

echo [4/8] Creating tag v1.1.5...
git tag -a v1.1.5 -m "Version 1.1.5 - Complete configuration fixes with all SSL and debug options"
echo.
...
echo ========================================
echo Release v1.1.5 completed successfully!
echo ========================================
echo.
echo What's new in v1.1.5:
echo - Complete configuration fixes in Step 2 installation guide
echo - Added all missing SSL and debug options to mailer configuration
echo - Updated examples/config-mail.php with complete PHPMailer configuration
echo - Fixed configuration examples to include all available options
echo - Added debug, debug_level, debug_output options to mailer config
echo - Added ssl_verify_peer, ssl_verify_peer_name, ssl_allow_self_signed options
echo - Ensured configuration examples match actual package capabilities
echo - Updated installation guide with complete configuration steps
echo - Fixed configuration consistency between README and example files
echo - Added all environment variables to mailer configuration example
echo.
echo Previous v1.1.4 features:
...
echo 2. Check GitHub repository for updated README and examples
echo 3. Test the new version in a Laravel project
echo 4. Verify that all configuration options work correctly
echo 5. Test SSL and debug options in different environments
echo.
pause
