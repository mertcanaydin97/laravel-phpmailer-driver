@echo off
echo ========================================
echo Laravel PHPMailer Driver v1.1.3 Release
echo ========================================
echo.
...
git commit -m "Release v1.1.3 - Comprehensive README update and documentation fixes"
echo.

echo [4/8] Creating tag v1.1.3...
git tag -a v1.1.3 -m "Version 1.1.3 - Comprehensive README update and documentation fixes"
echo.
...
echo ========================================
echo Release v1.1.3 completed successfully!
echo ========================================
echo.
echo What's new in v1.1.3:
...
echo 4. Verify that documentation matches actual package features
echo 5. Test all documented features and examples
echo.
pause
